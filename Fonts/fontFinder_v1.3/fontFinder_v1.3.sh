...
#Generate a dtae string to use for unique file names
...
cd /Users/Shared/fontFinder_v$versionNumber
...
python ./scripts/fontFinder.py ${delOption:-"-list"} $logFile /var/hogarth-del-fonts ${verboseOption:-"-verbose"} $dateTimeNow
